...
*/
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('first_name', 'last_name', 'user_image', 'company_id', 'entity_id', 'status');
...
$config['email_type'] = 'text';
	 ...
	 **/
	$config['email_activate']   = 'registration.tpl';
	...
	/**
	 * Invitation activated Template
     * Default : invited.tpl
	 **/
	$config['email_invite_activation']   = 'invited.tpl';
